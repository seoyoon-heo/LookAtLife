...
import { toDateStr, formatDate } from '../utils/date';
import { getWeatherEmoji, getTpoColor } from '../utils/format';
...
function Recommend() {
    ...
    const updateDateEvents = (date: Date) => {
    ...
    const getEventsOn = (y: number, m: number, d: number) =>
        allEvents.filter(e => {
                    ...
                    return (
                        <div key={poolIdx} style={{
                            ...
                            <div style={S.cardHead}>
                                ...
                                {isAccepted && <span style={S.acceptedBadge}>✅ 선택됨</span>}
                            </div>
...
const S: Record<string, React.CSSProperties> = {
    ...
    topCard: { background: '#fff', borderRadius: '18px', padding: '16px 18px', marginBottom: '20px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' },
    dateWeatherRow: { display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' },
    dateBtn: { display: 'flex', alignItems: 'center', gap: '8px', background: 'none', border: `1.5px solid ${theme.colors.border}`, borderRadius: '30px', padding: '8px 16px', cursor: 'pointer', flex: 1 },
    dateTxt:  { fontSize: '16px', fontWeight: '700', color: theme.colors.text },
    dateIcon: { fontSize: '16px', marginLeft: 'auto' },
    todayBtn: { padding: '7px 14px', background: theme.colors.primaryLight, color: theme.colors.primary, border: 'none', borderRadius: '20px', fontSize: '12px', cursor: 'pointer', fontWeight: '600', flexShrink: 0 },
    ...
    tpoBtn: { borderRadius: '14px', padding: '12px 6px', textAlign: 'center', cursor: 'pointer', border: 'none', transition: 'all .18s', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '5px' },
    tpoEmoji: { fontSize: '22px' },
    tpoName:  { fontSize: '12px', fontWeight: '600' },
    countWrap: { marginBottom: '16px' },
    countRow:  { display: 'flex', gap: '10px' },
    countBtn: { flex: 1, padding: '11px', borderRadius: '12px', fontSize: '14px', fontWeight: '700', cursor: 'pointer', transition: 'all .18s' },
    errorTxt: { color: theme.colors.danger, fontSize: '13px', marginBottom: '10px' },
    recBtn: { width: '100%', padding: '15px', background: theme.colors.primary, color: '#fff', border: 'none', borderRadius: '30px', fontSize: '15px', cursor: 'pointer', fontWeight: '800', marginBottom: '16px', boxShadow: `0 4px 16px ${theme.colors.primary}44` },
    poolBanner: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: theme.colors.primaryLight, borderRadius: '12px', padding: '10px 16px', marginBottom: '14px' },
    ...
    outfitCard: { background: '#fff', borderRadius: '18px', padding: '18px 16px', marginBottom: '14px', border: '2px solid transparent', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', transition: 'all .2s' },
    ...
    cardNum: { width: '28px', height: '28px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '13px', fontWeight: '900', color: '#fff', flexShrink: 0 },
    cardStyle: { fontSize: '16px', fontWeight: '800' },
    acceptedBadge: { fontSize: '12px', fontWeight: '700', color: theme.colors.primary, background: '#fff', border: `1.5px solid ${theme.colors.primary}`, padding: '3px 10px', borderRadius: '20px' },
    slotList: { background: '#F8FAFB', borderRadius: '12px', padding: '12px 14px', display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '12px' },
    ...
    cardDesc: { fontSize: '13px', color: theme.colors.textSub, lineHeight: '1.6', fontStyle: 'italic', margin: '0 0 14px', paddingLeft: '12px', borderLeft: `3px solid ${theme.colors.primaryLight}` },
    matchedWrap: { borderTop: `1px solid ${theme.colors.border}`, paddingTop: '12px', marginBottom: '14px' },
    ...
    matchedImgEmpty: { width: '68px', height: '68px', borderRadius: '10px', background: theme.colors.primaryLight, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '22px' },
    matchedCat: { fontSize: '9px', fontWeight: '700', color: '#fff', padding: '2px 6px', borderRadius: '4px' },
    matchedType: { fontSize: '10px', color: theme.colors.text, fontWeight: '500', margin: 0, textAlign: 'center', maxWidth: '68px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
    acceptBtn: { width: '100%', padding: '13px', background: theme.colors.primary, color: '#fff', border: 'none', borderRadius: '30px', fontSize: '14px', cursor: 'pointer', fontWeight: '700', boxShadow: `0 3px 10px ${theme.colors.primary}33` },
    acceptedRow: { padding: '12px', background: theme.colors.primaryLight, borderRadius: '12px', textAlign: 'center' },
    ...
    calPopup: { position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', background: '#fff', borderRadius: '20px', width: '340px', maxWidth: '90vw', zIndex: 201, boxShadow: '0 20px 60px rgba(0,0,0,0.2)', padding: '20px' },
    ...
    calDay:   { minHeight: '40px', borderRadius: '8px', padding: '4px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2px' },
};
